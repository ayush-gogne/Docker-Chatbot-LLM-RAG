...
Or use this single commmand to run all experimental results from the report: cd your dir/Docker-RAG-Project && python3 -m pip install -r requirements.txt && ollama pull llama3.2 && python3 collect_documents.py && python3 create_chunks.py && yes y | head -n 20 | python3 evaluate.py
